...
using System.Linq;
using System.Text;
using License3DotNet.licensor.hardware;
...
namespace License3DotNet.licensor
{
    ...
    {
        private static InterfaceSelector selector = new InterfaceSelector();
        private UUIDCalculator calculator = new UUIDCalculator(selector);
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine(hb.getMachineIdString());
        }
         ...
         * @throws UnsupportedEncodingException in case some error
         */
        public Boolean assertUUID(Guid uuid)
        {
